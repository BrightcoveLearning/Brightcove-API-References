 ...
 * @apiParam (Request Body Fields) {Boolean} enforce_geo=false Allow sharing only if affiliate account is enabled for geo-filtering (if the master account is enabled for geo-filtering) **Note: this field is currently ignored, but this restriction will be enabled later**
 *
 *
