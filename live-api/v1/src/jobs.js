 ...
 * @apiParam (Request Body Fields="us-west-2","ap-southeast-2","ap-northeast-1","ap-sounteast-1","eu-central-1","sa-east-1") {String} region AWS region - you can also specify region as the alias for a list set up for the account by Brightcove Support.
